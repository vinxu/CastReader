...
struct RootAuthGate: View {
    ...
    var body: some View {
        Group {
            ...
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderGrowthOfferFixture") {
                GrowthOfferAcceptanceFixture()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderOfflineFlowFixture") {
                KindleOfflineFlowFixture()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderOfflineDownloadFixture") {
                KindleOfflineDownloadFixture()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderOfflinePageFixture") {
                KindleOfflinePageFixture()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderSystemSpeechFixture") {
                SystemSpeechAcceptanceView()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderSleepTimerFixture") {
                SleepTimerAcceptanceFixture()
            } else if ProcessInfo.processInfo.arguments.contains("-CastReaderKindleSettingsFixture") {
