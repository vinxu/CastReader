...
// 引导的布局常量与通用组件已提到 `BoundLibraryOnboardingComponents.swift`，
// 供 Kindle 与微信读书两套首启引导共用。这里保留原名以免改动本文件其余调用点。
private typealias KindleOnboardingLayout = BoundLibraryOnboardingLayout
