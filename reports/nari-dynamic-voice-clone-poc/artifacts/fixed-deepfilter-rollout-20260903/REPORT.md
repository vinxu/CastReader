...
> 历史阶段说明：本文所述相对说话人一致性硬拒绝已由同日的[只告警修正](../fixed-deepfilter-warning-rollout-20260903/REPORT.md)取代。当前仍固定执行一次 DeepFilter atten24，但相对分数下降只记录警告，不再阻断创建。本文保留当时部署及事故证据。
